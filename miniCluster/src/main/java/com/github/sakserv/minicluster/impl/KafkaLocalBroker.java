...
public class KafkaLocalBroker implements MiniCluster {
    ...
    public void start() throws Exception {
        ...
        if (kafkaServerConstructor.getParameterTypes().length == 2) {
            kafkaServer = (KafkaServer) kafkaServerConstructor.newInstance(kafkaConfig, Time.SYSTEM);
        ...
        // Kafka 2.10 0.9.0 (HDP 2.3.4), pass in the threadPrefixName
            ...
            kafkaServer = (KafkaServer) kafkaServerConstructor.newInstance(kafkaConfig, Time.SYSTEM, threadPrefixName);
        ...
        // Kafka 2.10.1
            ...
            kafkaServer = (KafkaServer) kafkaServerConstructor.newInstance(kafkaConfig, Time.SYSTEM, threadPrefixName, kafkaMetricsReporters);
        }
